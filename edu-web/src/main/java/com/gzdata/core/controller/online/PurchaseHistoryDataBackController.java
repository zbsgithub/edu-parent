 ...
 * @since 2021年01月15日
 */
@Api(tags="已购代捐-购买历史列表--普通分页")
@RequestMapping("/api/")
@RestController
public class PurchaseHistoryDataBackController {
	 ...
	 */
	@ApiOperation("分页数据")
	@GetMapping("data/purchase/history/pagelist")
	 ...
	 */
	@ApiOperation("条件查询")
	@GetMapping("data/purchase/history/list")
	 ...
	 * @update:[变更日期YYYY-MM-DD][更改人姓名][变更描述]
	 */
	@RequestMapping("data/purchase/history/add")
	@ResponseBody
