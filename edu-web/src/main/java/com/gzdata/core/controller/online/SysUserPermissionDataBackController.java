...
@RestController
@RequestMapping("/api/")
public class SysUserPermissionDataBackController {
	 ...
	 */
	@ApiOperation("普通分页")
	@GetMapping("data/sys/user/permission/pagelist")
	 ...
	 */
	@ApiOperation("通过条件查询")
	@GetMapping("data/sys/user/permission/list")
	 ...
	 */
	@ApiOperation("获取详情")
	@GetMapping("data/sys/user/permission/detail")
	 ...
	 */
	@ApiOperation("批量删除")
	@GetMapping("data/sys/user/permission/batch_delete")
	 ...
	 */
	@ApiOperation("单个删除")
	@GetMapping("data/sys/user/permission/delete")
	 ...
	 */
	@ApiOperation("添加数据")
	@PostMapping("data/sys/user/permission/add")
	 ...
	 */
	@ApiOperation("修改数据")
	@PostMapping("data/sys/user/permission/update")
